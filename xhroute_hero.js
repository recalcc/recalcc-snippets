// from https://github.com/TOMODOcom/TOMODOkorz/blob/master/tomodo.korz.js
//ifndef
if(typeof korz == 'undefined'){

    var korz = {
       router:"http://oauthbouncer.herokuapp.com/"
    };
        ...
        this.yokoman = function(){
            if(!superHttpRequest.isRelative()){
                ...
                if(superHttpRequest.isCrossDomain()){
                    superHttpRequest.openArguments[1] = korz.router +  superHttpRequest.url.replace("http://","").replace(":80","");
                }
            }
            //
        }
