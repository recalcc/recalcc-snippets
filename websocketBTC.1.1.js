...
// TODO: calculate heights , copy diffs with .1

// /intgfx/BTC2/%7B"a":[["C3","1st"]],"c":[["C10","bid"],["C9","ask"]]%7D
//window.open('/intgfx/BTC2/%7B"a":[["C11","spread pc"]],"c":[["C3","1st"],["C10","bid"],["C9","ask"]]%7D'); //TODO:lookup _room
window.open('/intgfx/BTC2/{"a":[["C11","spread pc"]],"c":[["C3","1st"],["C10","bid"],["C9","ask"]]}'); //TODO:lookup _room
...
ws.onmessage = function(message) {
    ...
    if (obj["channel_name"] == "ticker.BTCUSD") {
        ...
        if (!spreadsheet.editor.busy) {
            ...
            sset("C8", obj.stamp);
            sset("C9", bestbid/100000);
            sset("C10", bestask/100000);
            sset("C11", Math.round(spread*10)/10); // TODO: uset set_str
        }
